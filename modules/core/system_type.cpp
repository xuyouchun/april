...
namespace X_ROOT_NS::modules::core {
    ...
    // Impl for System.SystemException
    class __system_exception_type_impl_t : public __tcore_type_impl_t<vtype_t::mobject_>
    {
        typedef __tcore_type_impl_t<vtype_t::mobject_> __super_t;
    ...
    const char_t __system_exception_type_impl_t::type_name[]
                                        = __CoreTypeName(CoreType_SystemException);
    ...
    const char_t __invalid_cast_exception_type_impl_t::type_name[]
                                        = __CoreTypeName(CoreType_InvalidCastException);
