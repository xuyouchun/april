...
namespace X_ROOT_NS { namespace modules { namespace core {
    ...
    #define __Mt mt_position_field_t

    // Metadata: Position field.
    __DefineEntityIOFunctions
        __M(host), __M(position), __V(1),
    __EndDefineEntityIOFunctions
    ...
    // Metadata: Param.
    __DefineEntityIOFunctions
        __M(name), __M(attributes), __M(type), __M(param_type), __M(default_value), __V(1),
    __EndDefineEntityIOFunctions
